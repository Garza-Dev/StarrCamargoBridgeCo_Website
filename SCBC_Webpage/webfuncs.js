function baluarteBtn() {
    document.getElementById("bg_img_infobox").style.backgroundImage = "url(images&videos/PICS/BaluarteBridge3.jpg)";
    document.getElementById("infobox_txt_h1").textContent = "Baluarte Bridge";
    document.getElementById("infobox_txt_p").textContent = "The Mazatlán-Durango highway project is the last link in a transversal inter-oceanic corridor connecting Mexico's Pacific Coast with the Gulf of Mexico. Connecting Mexico's Pacific Coast with The Gulf of Mexico.";
}

function loopBtn() {
    document.getElementById("bg_img_infobox").style.backgroundImage = "url(images&videos/PICS/truck02.jpg)";
...
function shortcutBtn() {
    document.getElementById("bg_img_infobox").style.backgroundImage = "url(images&videos/PICS/MX-USA.jpg)";
...
function demoBtn() {
    document.getElementById("bg_img_infobox").style.backgroundImage = "url(images&videos/PICS/MX-US-CAN2.jpg)";
